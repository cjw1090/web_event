...
module.exports = function(passport) {
  ...
  const callbackURL = (process.env.NONE_ENV == 'production')?
    'https://thawing-ridge-50883.herokuapp.com/auth/facebook/callback' :
    'http://localhost:3000/auth/facebook/callback';
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : process.env.FBID || '812834428897144',
    clientSecret : process.env.FB_SECRET || '1d2b464baa2a19e20f16a4c67d73b1d0',
